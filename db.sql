...
--
-- Host: 127.0.0.1    Database: db_semillero_sinergy
-- ------------------------------------------------------
...
CREATE TABLE `ciudades` (
  ...
  `nombre_ciu` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_dep` int DEFAULT NULL,
  PRIMARY KEY (`codigo_ciu`),
  KEY `codigo_dep` (`codigo_dep`),
  CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`codigo_dep`) REFERENCES `departamentos` (`codigo_dep`)
...
CREATE TABLE `departamentos` (
  ...
  `nombre_dep` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `estudiantes_proyectos` (
  `ide_est_pro` int NOT NULL AUTO_INCREMENT,
  `codigo_pro` int DEFAULT NULL,
  `id_per` int NOT NULL,
  `documento_per` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rol_est_pro` int DEFAULT NULL,
  `horassemana` int DEFAULT NULL,
  `semestreacademico` int DEFAULT NULL,
  `promedio` float DEFAULT NULL,
  `mesessemillero` int DEFAULT NULL,
  PRIMARY KEY (`ide_est_pro`),
  KEY `documento_per` (`documento_per`),
  KEY `fk_codigo_pro` (`codigo_pro`),
  CONSTRAINT `estudiantes_proyectos_ibfk_1` FOREIGN KEY (`documento_per`) REFERENCES `personas` (`documento_per`),
  CONSTRAINT `fk_codigo_pro` FOREIGN KEY (`codigo_pro`) REFERENCES `proyectos` (`codigo_pro`)
) ENGINE=InnoDB AUTO_INCREMENT=134681 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `estudiantes_proyectos` VALUES (134680,18,15,'91514447',0,15,5,4.2,12);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lineas` (
  `codigo_lin` int NOT NULL,
  `nombre_lin` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_lin` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_sem` int DEFAULT NULL,
  PRIMARY KEY (`codigo_lin`),
  KEY `codigo_sem` (`codigo_sem`),
  CONSTRAINT `lineas_ibfk_1` FOREIGN KEY (`codigo_sem`) REFERENCES `semilleros` (`codigo_sem`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lineas` VALUES (132006,'Desarrollo de Software','Activo',1);
...
CREATE TABLE `menu` (
  ...
  `nombre_men` varchar(70) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `permisos` (
  ...
  `codigo_men` int DEFAULT NULL,
  `codigo_tip` int DEFAULT NULL,
  `acceso` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`codigo_per`),
  KEY `codigo_men` (`codigo_men`),
  KEY `codigo_tip` (`codigo_tip`),
  CONSTRAINT `permisos_ibfk_1` FOREIGN KEY (`codigo_men`) REFERENCES `menu` (`codigo_men`),
  CONSTRAINT `permisos_ibfk_2` FOREIGN KEY (`codigo_tip`) REFERENCES `tipopersonas` (`codigo_tip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `personas` (
  ...
  `documento_per` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_per` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellidos_per` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fechanacimiento` date DEFAULT NULL,
  `email_per` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telefono_per` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `foto_per` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_per` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password_per` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_tip` int DEFAULT NULL,
  `codigo_sem` int DEFAULT NULL,
  PRIMARY KEY (`id_per`),
  KEY `codigo_tip` (`codigo_tip`),
  KEY `codigo_sem` (`codigo_sem`),
  KEY `documento_per` (`documento_per`) USING BTREE,
  CONSTRAINT `personas_ibfk_1` FOREIGN KEY (`codigo_tip`) REFERENCES `tipopersonas` (`codigo_tip`),
  CONSTRAINT `personas_ibfk_2` FOREIGN KEY (`codigo_sem`) REFERENCES `semilleros` (`codigo_sem`)
...
INSERT INTO `personas` VALUES (9,'1097102912','Santiago','Barón','2023-10-04','Santiago@gmail.com','3215486719','./fotos_perfil/Santiago.jpg','Inactivo','543210',2,2),(10,'1097910189','Cristian','Barón','2004-05-06','Baronrodriguezcristian@gmail.com','3134534867','./fotos_perfil/Yo.png','Activo','1234',3,2),(11,'123456789','Yomira ','Jerez','2003-05-08','dy.jerezojeda@unicienciabga.edu.co','3212590507','./fotos_perfil/Ana.jpeg','Activo','Y+*-810911',2,2),(15,'91514447','Manuel','Barón','2023-10-18','mebp32@hotmail.com','311564892','./fotos_perfil/Manuel.jpg','Activo','123',2,2),(18,'63327090','Amparo ','Rueda','2025-04-11','Amparo.rueda@gmail.com','3178339612','./fotos_perfil/Amparo.jpg','Activo','Amparo+123',2,2);
/*!40000 ALTER TABLE `personas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profesores_proyectos`
--

DROP TABLE IF EXISTS `profesores_proyectos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `profesores_proyectos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fk_id_proyecto` int DEFAULT NULL,
  `fk_id_profesor` int DEFAULT NULL,
  `creation` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_id_proyecto` (`fk_id_proyecto`),
  KEY `fk_id_profesor` (`fk_id_profesor`),
  CONSTRAINT `fk_id_profesor` FOREIGN KEY (`fk_id_profesor`) REFERENCES `personas` (`id_per`),
  CONSTRAINT `fk_id_proyecto` FOREIGN KEY (`fk_id_proyecto`) REFERENCES `proyectos` (`codigo_pro`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profesores_proyectos`
--

LOCK TABLES `profesores_proyectos` WRITE;
/*!40000 ALTER TABLE `profesores_proyectos` DISABLE KEYS */;
INSERT INTO `profesores_proyectos` VALUES (1,18,15,'2025-04-18 18:03:19');
/*!40000 ALTER TABLE `profesores_proyectos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `programas` (
  ...
  `nombre_pro` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `programas` VALUES (1,'Derecho Institucional'),(2,'Ingenieria de Sistemas');
...
CREATE TABLE `proyectos` (
  `codigo_pro` int NOT NULL AUTO_INCREMENT,
  `tiutlo_pro` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_pro` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `anio_pro` int DEFAULT NULL,
  `mes_pro` int DEFAULT NULL,
  `palabras_pro` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_ciu` int DEFAULT NULL,
  `duracion_pro` int DEFAULT NULL,
  `codigo_tip_pro` int DEFAULT NULL,
  `horassemanalider_pro` int DEFAULT NULL,
  `resumen` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `planteamientoproblema` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `justificacion` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `preguntainvestigacion` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `marcoteorico` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estadoarte` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `objetivogeneral` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `objetivosespecificos` varchar(800) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `metodologia` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cronograma` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `resultadosProductos` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bibliografia` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `presupuesto` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gastosprofesores` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gastosequipos` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gastossoftware` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gastosviajes` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gastosplanformacion` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rutaarchivo_pro` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_pro`),
  KEY `codigo_ciu` (`codigo_ciu`),
  KEY `codigo_tip_pro` (`codigo_tip_pro`),
  CONSTRAINT `proyectos_ibfk_1` FOREIGN KEY (`codigo_ciu`) REFERENCES `ciudades` (`codigo_ciu`),
  CONSTRAINT `proyectos_ibfk_2` FOREIGN KEY (`codigo_tip_pro`) REFERENCES `tipoproyectos` (`codigo_tip_pro`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `proyectos_profesor`
--

LOCK TABLES `proyectos_profesor` WRITE;
/*!40000 ALTER TABLE `proyectos_profesor` DISABLE KEYS */;
INSERT INTO `proyectos_profesor` VALUES (2,0,1,'2024-09-25 05:26:02'),(3,11,1,'2024-09-25 05:28:58');
/*!40000 ALTER TABLE `proyectos_profesor` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `semilleros` (
  `codigo_sem` int NOT NULL AUTO_INCREMENT,
  `nombre_sem` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fechacreacion_sem` date DEFAULT NULL,
  `estado_sem` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_pro` int DEFAULT NULL,
  PRIMARY KEY (`codigo_sem`),
  KEY `codigo_pro` (`codigo_pro`),
  CONSTRAINT `semilleros_ibfk_1` FOREIGN KEY (`codigo_pro`) REFERENCES `programas` (`codigo_pro`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `semilleros` VALUES (1,'Cimed','2018-10-05','Activo',1),(2,'Sinergy','2013-06-05','Activo',2);
...
CREATE TABLE `tipopersonas` (
  `codigo_tip` int NOT NULL AUTO_INCREMENT,
  `nombre_tip` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_tip`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tipopersonas` VALUES (1,'Estudiante'),(2,'Profesor'),(3,'Admin');
/*!40000 ALTER TABLE `tipopersonas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tipoproyectos`
--
...
CREATE TABLE `tipoproyectos` (
  `codigo_tip_pro` int NOT NULL AUTO_INCREMENT,
  `nombre_tip_pro` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo_tip_pro`)
) ENGINE=InnoDB AUTO_INCREMENT=361 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipoproyectos`
--

LOCK TABLES `tipoproyectos` WRITE;
/*!40000 ALTER TABLE `tipoproyectos` DISABLE KEYS */;
INSERT INTO `tipoproyectos` VALUES (255,'Software'),(360,'Investigativo');
/*!40000 ALTER TABLE `tipoproyectos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'db_semillero_sinergy'
--

--
-- Dumping routines for database 'db_semillero_sinergy'
--
...
-- Dump completed on 2025-04-19 16:52:49
